...
//think_path D:\phpStudy\WWW\tp/
//app_path  D:/phpStudy/WWW/tp/
...
if(!IS_CLI) {
    ...
    if(!defined('_PHP_FILE_')) {
        if(IS_CGI) {
            //var_dump(IS_CGI);exit;
            //运行php_sapi 包含cgi
            //CGI/FASTCGI模式下
            //var_dump($_SERVER['PHP_SELF']); //STRING  '/'
            $_temp  = explode('.php',$_SERVER['PHP_SELF']); //array('/');
            //var_dump($_temp);EXIT;
            //var_dump($_SERVER['HTTP_HOST']);exit; 网站域名
...
// 加载核心Think类
require CORE_PATH.'Think'.EXT; //加载Think.class.php 核心类
// 应用初始化 
Think\Think::start();